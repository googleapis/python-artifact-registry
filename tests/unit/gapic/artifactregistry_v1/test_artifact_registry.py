...
from google.devtools.artifactregistry_v1.services.artifact_registry import (
...
from google.devtools.artifactregistry_v1.services.artifact_registry.transports.base import (
...
def test_artifact_registry_client_client_options_from_dict():
    with mock.patch(
        "google.devtools.artifactregistry_v1.services.artifact_registry.transports.ArtifactRegistryGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_docker_images(
    transport: str = "grpc", request_type=artifact.ListDockerImagesRequest
):
    client = ArtifactRegistryClient(
...
def test_artifact_registry_base_transport():
    ...
    with mock.patch(
        "google.devtools.artifactregistry_v1.services.artifact_registry.transports.ArtifactRegistryTransport.__init__"
    ) as Transport:
...
def test_artifact_registry_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.devtools.artifactregistry_v1.services.artifact_registry.transports.ArtifactRegistryTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
