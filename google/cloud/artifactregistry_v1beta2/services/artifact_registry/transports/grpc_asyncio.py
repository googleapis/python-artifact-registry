...
class ArtifactRegistryGrpcAsyncIOTransport(ArtifactRegistryTransport):
    ...
    def create_repository(
        ...
        [gda_repository.CreateRepositoryRequest], Awaitable[operations.Operation]
    ]:
    ...
    def delete_repository(
        ...
        [repository.DeleteRepositoryRequest], Awaitable[operations.Operation]
    ]:
    ...
    def delete_package(
        self,
    ) -> Callable[[package.DeletePackageRequest], Awaitable[operations.Operation]]:
    ...
    def delete_version(
        self,
    ) -> Callable[[version.DeleteVersionRequest], Awaitable[operations.Operation]]:
    ...
    @property
    def delete_tag(self) -> Callable[[tag.DeleteTagRequest], Awaitable[empty.Empty]]:
